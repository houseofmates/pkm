// simple rag test that doesn't rely on path aliases// run with: npx ts-node scripts/test-rag-simple.ts
...
async function runSimpleTest() {
  ...
  try {
    // test 1: search knowledge base    console.log('1️⃣ testing knowledge base search...');
    ...
    // test 2: build rag context    console.log('\n2️⃣ testing rag context building...');
    ...
    // test 3: generate wilson prompt    console.log('\n3️⃣ testing wilson prompt generation...');
