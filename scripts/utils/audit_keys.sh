...
# high-entropy strings (generic api keys) - filtering common code keywordsecho "Checking generic high-entropy strings..."
...
# specific patternsecho "Checking 'Authorization' headers..."
