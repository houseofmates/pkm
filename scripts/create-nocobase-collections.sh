...
# Get API URL and token from environment or use defaults
API_URL="${NOCOBASE_URL:-http://localhost:8091}/api"
TOKEN="${NOCOBASE_API_KEY:-eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsInJvbGVOYW1lIjoicm9vdCIsImlhdCI6MTc3NDY0NTY5MiwiZXhwIjoxNzc0NzMyMDkyfQ.ktX5jcezmLhxZISaBqqHS_eg45FIIogkW8NQb-EL7n4}"
...
create_field "exercise" "rpe" "integer" "integer" ', "x-component": "InputNumber"'
...
create_field "sleep" "sleep_quality" "integer" "integer" ', "x-component": "InputNumber"'
...
create_field "sleep" "stress_level" "integer" "integer" ', "x-component": "InputNumber"'
