...
const files = [
  ...
  'packages/core/src/lib/storage-manager.ts',
  ...
  'packages/core/src/hooks/use-records.ts',
  'packages/core/src/hooks/use-collections.ts',
  'packages/core/src/hooks/use-hibernation-streak.ts',
  'packages/core/src/features/records/components/record-table.tsx',
  'apps/web/src/lib/activity-sync.ts',
  'tests/use-collections.test.tsx'
];
