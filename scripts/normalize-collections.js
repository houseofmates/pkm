...
/*
  ...
  Usage:
    NOCOBASE_URL=http://localhost:4100/api ADMIN_API_KEY="Bearer <token>" node scripts/normalize-collections.js [--dry-run]
...
if (!base || !apiKey) {
  ...
  console.error('Example: NOCOBASE_URL=http://localhost:4100/api ADMIN_API_KEY="Bearer ..." node scripts/normalize-collections.js --dry-run');
  process.exit(2);
}
