            ...
            <div className="p-4 border-b space-y-4 bg-neutral-900/50">
                <div className="flex items-start gap-4">
                    <div className="flex-1 space-y-1">
                        <Label className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider">title / name</Label>
                        <Input
                            value={title}
                            onChange={(e) => setTitle(e.target.value)}
                            onBlur={(e) => handleTitleChange(e.target.value)}
                            className="h-8 font-semibold text-sm bg-[#060606] border-transparent hover:border-input focus:border-primary transition-colors text-white"
                        />
                    </div>
                ...
                <div className="space-y-3 p-1">
                    ...
                    {onConfigChange && (
                        <div className="mb-4 p-2 border rounded-md bg-muted/20 space-y-2">
                            <Label className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider mb-2 block">display properties (max 3)</Label>
                    ...
                    <Label className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider mb-2 block">all properties</Label>
