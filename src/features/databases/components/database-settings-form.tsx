    ...
    return (
        <div className="space-y-4">
            ...
            <div className="space-y-3">
                ...
                <div className="space-y-1">
                    <Label className="text-xs text-muted-foreground uppercase">associated image</Label>
            ...
            {currentView && (
                <div className="space-y-2">
                    <Label className="text-xs text-muted-foreground uppercase">default view</Label>
                    <Button
                        variant="outline"
                        size="sm"
            ...
            {(['gallery', 'list', 'calendar', 'timeline', 'gantt'].includes(currentView || '')) && onUpdateConfig && (
                <div className="space-y-3">
                    <Label className="text-xs text-muted-foreground uppercase">{currentView} appearance</Label>
