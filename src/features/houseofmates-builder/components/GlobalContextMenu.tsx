...
export function GlobalContextMenu({ x, y, onClose }: Props) {
    ...
    return (
        <>
            ...
            >
                {/* Background Section */}
                <div className="px-3 py-1 text-[10px] uppercase tracking-wider text-white/40">clipboard</div>
                ...
                <div className="px-3 py-1 text-[10px] uppercase tracking-wider text-white/40">background</div>
                ...
                {/* Pages Section */}
                <div className="px-3 py-1 text-[10px] uppercase tracking-wider text-white/40">pages</div>
                ...
                {/* Add Element Section */}
                <div className="px-3 py-1 text-[10px] uppercase tracking-wider text-white/40">add element</div>
