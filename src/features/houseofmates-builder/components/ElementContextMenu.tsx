...
export function ElementContextMenu({ element, x, y, onClose }: Props) {
    ...
    const handleBorderChange = () => {
        ...
        const color = prompt('border color (hex):', element.styles?.borderColor || '#ffffff');
        if (width !== null && color) {
            updateElement(element.id, {
                styles: {
                    ...element.styles,
                    borderWidth: parseInt(width) || 0,
                    borderColor: color,
                }
            });
        }
    ...
    return (
        <>
            ...
            >
                {/* Styling Section */}
                <div className="px-3 py-1 text-[10px] uppercase tracking-wider text-white/40 lowercase">styling</div>
                ...
                {/* Layer Controls */}
                <div className="px-3 py-1 text-[10px] uppercase tracking-wider text-white/40 lowercase">layers</div>
                ...
                {/* Interactions */}
                <div className="px-3 py-1 text-[10px] uppercase tracking-wider text-white/40 lowercase">interactions</div>
                ...
                {element.type === 'database_view' && (
                    <>
                        <div className="h-px bg-white/10 my-1" />
                        <div className="px-3 py-1 text-[10px] uppercase tracking-wider text-white/40 lowercase">data</div>
                        <button
                            onClick={() => {
