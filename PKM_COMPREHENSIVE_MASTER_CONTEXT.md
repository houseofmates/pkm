...
✅ **automation**: n8n workflows + local llm (qwen2.5vl:7b-q4_K_M via ollama)  
...
- uses qwen2.5vl:7b-q4_K_M via ollama to extract:
...
3. if `isLink`:
   ...
   - call ollama (qwen2.5vl:7b-q4_K_M) to summarize
...
**model**: `qwen2.5vl:7b-q4_K_M` (7 billion parameter)
...
- intent parsing with qwen2.5vl:7b-q4_K_M
- features:
...
**oracle**: ai-powered semantic search system using qwen2.5vl:7b-q4_K_M  
...
- **ai**: local llms (ollama running qwen2.5vl:7b-q4_K_M) via api.
...
- **model**: `qwen2.5vl:7b-q4_K_M` (optimized for speed/quality balance).
- **usage**:
