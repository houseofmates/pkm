...
>(({ className, style, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ...
      collisionPadding={16}
      className={cn(
        "z-50 min-w-[8rem] overflow-auto rounded-md border shadow-lg animate-in fade-in-80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        className
      )}
      style={{
        ...
        color: '#ffffff',
        padding: '0.25rem',
        maxHeight: 'var(--radix-context-menu-content-available-height, 80vh)',
        ...style,
      }}
      {...props}
    />
