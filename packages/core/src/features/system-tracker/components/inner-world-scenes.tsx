...
export function InnerWorldScenes() {
  const { scenes, refreshScenes } = useSystemTracker();
  ...
  if (scenes.length === 0) {
    return (
      <div style={{ padding: '2rem', backgroundColor: '#0a0a0a', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
