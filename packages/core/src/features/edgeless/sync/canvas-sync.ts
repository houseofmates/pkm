...
getLatestCheckpoint,
=======
// now integrated with robust sync service for bulletproof reliability
...
class CanvasSyncService {
  private timer: ReturnType<typeof setInterval> | null = null
  private syncState: Map<string, SyncState> = new Map()
  private isRobustSyncEnabled = true
  ...
  start(): void {
    ...
    // start robust sync service if enabled
