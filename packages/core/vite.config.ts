...
const proxyConfig = {
  ...
  '/api/nocobase': { target: process.env.VITE_NOCOBASE_PROXY_URL || `http://${process.env.VITE_LOCAL_IP_192_168 || '192.168.4.233'}:8091/api`, changeOrigin: true, rewrite: (p: string) => p.replace(/^\/api\/nocobase/, '') },
  ...
  '/api': { target: process.env.VITE_NOCOBASE_PROXY_URL || `http://${process.env.VITE_LOCAL_IP_192_168 || '192.168.4.233'}:8091/api`, changeOrigin: true, rewrite: (p: string) => p.replace(/^\/api/, '') },
  '/storage': { target: process.env.VITE_STORAGE_PROXY_URL || `http://${process.env.VITE_LOCAL_IP_192_168 || '192.168.4.233'}:8091`, changeOrigin: true, secure: false },
  '/ollama': { target: process.env.VITE_OLLAMA_PROXY_URL || `http://${process.env.VITE_LOCAL_IP_192_168_OLLAMA || '192.168.4.250'}:11434`, changeOrigin: true, rewrite: (p: string) => p.replace(/^\/ollama/, '') },
