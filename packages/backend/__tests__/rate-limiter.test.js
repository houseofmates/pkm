// tests for rate limiter middlewareimport { describe, it, expect, beforeEach, vi } from 'vitest';
...
describe('Rate Limiter', () => {
    ...
    beforeEach(() => {
        // reset environment variables for testing        process.env.RATE_LIMIT_WINDOW_MS = '60000';
